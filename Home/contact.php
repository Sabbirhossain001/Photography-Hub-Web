          ...
          <div class="dropdown">
           ...
           <div class="container" style="height: 800px; border: solid 2px whitesmoke;">
            ...
            <form class="form-feedback" action="" method="POST">
                ...
                <input type="text" id="inputSubject" name="inputSubject" class="form-control" placeholder="Subject.." required="">

                <textarea name="inputDetails" id="inputDetails" class="form-control" cols="30" rows="5" placeholder="Go ahead we'r listening.."></textarea>
